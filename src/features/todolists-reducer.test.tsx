import {
    createTodolistAC, FilterValuesType,
...
test('correct todolist should change its name', () => {
    ...
    const action = updateTodolistAC(todolistId2, {title:newTodolistTitle});
...
test('correct filter of todolist should be changed', () => {
    ...
    const action = updateTodolistAC(todolistId2, {filter:newFilter});
    const endState = todolistsReducer(startState, action);
